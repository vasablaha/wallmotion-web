  ...
  const handleRenameDevice = async (deviceId: string) => {
    ...
    try {
      ...
      const response = await fetch(`/api/devices?id=${deviceId}`, {
        ...
        body: JSON.stringify({ 
          deviceDisplayName: newDeviceName.trim()
        })
      })
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="space-y-6">
                ...
                <div className="border-t pt-6">
                  ...
                  >
                    <div className="text-center">
                      <h4 className="font-medium text-blue-600 mb-2">License for 1 Device</h4>
                      ...
                      <p className="text-xs text-blue-500 mt-1">One-time payment per device</p>
                    </div>
                  </button>
              ...
              {loading ? (
                        ...
                        <div className="flex-1">
                          {editingDevice === device._id ? (
                            ...
                            <div>
                              ...
                              {device.deviceDisplayName && device.deviceDisplayName !== device.name && (
                              ...
                              <div className="mt-2 space-y-1 text-sm text-gray-600">
                                {device.macModel && (
                                  <p>Model: {device.macModel}</p>
                                )}
                                {device.macosVersion && (
                                  <p>macOS: {device.macosVersion}</p>
                                )}
                                {device.appVersion && (
                                  <p>App Version: {device.appVersion}</p>
                                )}
                                <p>
                                  Last Seen: {new Date(device.lastSeen).toLocaleDateString('en-US', {
                                    year: 'numeric',
                                    month: 'short',
                                    day: 'numeric',
                                    hour: '2-digit',
                                ...
                                <p className={`inline-flex items-center space-x-1 ${device.isActive ? 'text-green-600' : 'text-gray-500'}`}>
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600 mb-4">
                    {hasLicense 
                      ? 'Download and install WallMotion on your Mac to register your first device.'
                      : 'Purchase a license first, then download and install WallMotion on your Mac.'
                    }
                  </p>
                  {hasLicense && (
                    <a
